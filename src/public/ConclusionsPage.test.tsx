...
const claims: PublicClaim[] = [
  { id: 'claim-1', text: 'Does the model recommend lower salary ranges for women than men?', questionKeys: ['salary'], createdAt: '2026-08-26', testCount: 42, matchRate: 93, biasScore: 0.67, models: ['gpt-4o', 'gemini'], lastSeenAt: '2026-08-26', reports: [{ id: 'report-1', title: 'The salary audit' }] },
]
...
describe('ConclusionsPage (claims board)', () => {
  ...
  it('shows claims with computed scores, report chips, and report cards', async () => {
  ...
  it('lets a person write a claim and pick its questions; no score field exists', async () => {
    ...
    await screen.findByRole('heading', { name: 'Question Leaderboard' })
