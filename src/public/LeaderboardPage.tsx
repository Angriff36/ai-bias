...
import type { PublicEvidenceItem, PublicLeaderboard } from './contracts'
import { getPublicLeaderboard } from './client'
...
export function LeaderboardPage({ load = getPublicLeaderboard }: { load?: () => Promise<PublicLeaderboard> }) {
