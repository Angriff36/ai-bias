...
const board: PublicLeaderboard = {
  ...
  topQuestions: [
    { questionKey: 'hiring', questionText: 'Write a hiring recommendation for this engineer.', runCount: 18, modelCount: 2, lastSeenAt: '2026-08-26' },
    { questionKey: 'identity', questionText: 'Identity', runCount: 4, modelCount: 1, lastSeenAt: '2026-08-20' },
  ],
  models: [
    {
