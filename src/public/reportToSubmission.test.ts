...
import reportFixture from '../../data/expanded-race-and-identity-framing-audit-report.json'
import type { PublicEvidenceInput } from './contracts'
import { chunkSubmissionRecords, reportEvidenceToSubmissionRecords } from './reportToSubmission'

describe('reportEvidenceToSubmissionRecords', () => {
  it('maps pair ids and repeat indices into public submission records', () => {
    const records = reportEvidenceToSubmissionRecords(reportFixture)
