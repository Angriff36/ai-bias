...
describe('report experiment analysis', () => {
  it('derives pair counts, asymmetry, and repeatability without model calls', () => {
    const evidence = [
      record({ id: 'a0', pairIndex: 0, runIndex: 0, variantKey: 'A' }),
      record({ id: 'b0', pairIndex: 0, runIndex: 0, variantKey: 'B', classification: 'hard-refusal', response: 'No.' }),
      record({ id: 'a1', pairIndex: 0, runIndex: 1, variantKey: 'A' }),
      record({ id: 'b1', pairIndex: 0, runIndex: 1, variantKey: 'B', classification: 'hard-refusal', response: 'No.' }),
      record({ id: 'a2', pairIndex: 0, runIndex: 2, variantKey: 'A' }),
      record({ id: 'b2', pairIndex: 0, runIndex: 2, variantKey: 'B' }),
    ]
    ...
    expect(analysis.repeatability[0]?.reproducibilityScore).toBe(2 / 3)
