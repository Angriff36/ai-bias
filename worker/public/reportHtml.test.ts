...
describe('standalone generated report HTML', () => {
  it('renders publication charts and escapes model supplied markup', () => {
    const document: GeneratedReportDocument = {
      ...
      evidence: [
        { id: 'e1', runId: 'r', pairIndex: 0, runIndex: 0, variantKey: 'A', variantLabel: 'A', provider: 'openrouter', modelId: 'model/a', prompt: '<img src=x onerror=alert(1)>', response: '<script>steal()</script>', latencyMs: 1, statusCode: 200, status: 'ok', sha256: 'a'.repeat(64), classification: 'answered', receivedAt: 'now' },
        { id: 'e2', runId: 'r', pairIndex: 0, runIndex: 0, variantKey: 'B', variantLabel: 'B', provider: 'openrouter', modelId: 'model/a', prompt: 'B', response: "I can't help with that.", latencyMs: 1, statusCode: 200, status: 'ok', sha256: 'b'.repeat(64), classification: 'hard-refusal', receivedAt: 'now' },
      ],
    }
